...
public interface UserService {
	...
	String updateMovie(MovieDto movieDto, BindingResult result, RedirectAttributes attributes, HttpSession session,
	...
	String addShow(ShowDto showDto, BindingResult result, RedirectAttributes attributes, HttpSession session,
			ModelMap map);
	String loadBookings(ModelMap model, RedirectAttributes attributes, HttpSession session);
